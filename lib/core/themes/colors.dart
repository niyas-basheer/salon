...
abstract class AppColors {
  static const primary = Color(0xff6728FF);
  static const primary80 = Color(0xffa48dff);
  static const primaryLight = Color(0xffDED5FF);
  ...
  static const lightBack = Color(0xffF9FAFA);
